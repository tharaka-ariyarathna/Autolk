...
public class Registration {
    ...
    //After registration user manually have to login again as registration doesn't return any user Id
    ...
    public void setRegistration(){
        ...
        registerButton.addActionListener(e -> {
            ...
            if (registartionConfirmPassword.equals((registrationPassword))) {
                try {
                    int newId = dataBase.getData("SELECT id FROM user ORDER BY id DESC LIMIT 1;") + 1 ;
